...
void CircularProgressSettingsEditor::setupForm()
{
    ...
    {
    case XXMaterial::DeterminateProgress:
        ui->progressTypeComboBox->setCurrentIndex(0);
        break;
    case XXMaterial::IndeterminateProgress:
...
void CircularProgressSettingsEditor::updateWidget()
{
    ...
    {
    case 0:
        m_progress->setProgressType(XXMaterial::DeterminateProgress);
        break;
    case 1:
        m_progress->setProgressType(XXMaterial::IndeterminateProgress);
        break;
    default:
        break;
    }
