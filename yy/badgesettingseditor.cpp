...
#include "xx/qtmaterialbadge.h"

BadgeSettingsEditor::BadgeSettingsEditor(QWidget *parent)
    : QWidget(parent),
      ui(new Ui::BadgeSettingsForm),
      m_avatar(new QtMaterialAvatar(QImage("../qt-material-widgets/sikh.jpg"))),
...
void BadgeSettingsEditor::updateWidget()
{
    ...
    case 0:
        ...
        break;
    case 1:
        m_badge->setIcon(QIcon("../qt-material-widgets/ic_star_black_24px.svg"));
        break;
    default:
        break;
    }
