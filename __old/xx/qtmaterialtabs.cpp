...
#include "xx/qtmaterialtabs_p.h"
#include <QHBoxLayout>
#include "xx/qtmaterialtabs_internal.h"
...
void QtMaterialTabsPrivate::QtMaterialTabsPrivate::init()
{
    ...
    rippleStyle    = XXMaterial::CenteredRipple;
    tab            = -1;
    showHalo       = true;
    useThemeColors = true;
...
void QtMaterialTabs::setRippleStyle(XXMaterial::RippleStyle style)
{
    Q_D(QtMaterialTabs);
...
XXMaterial::RippleStyle QtMaterialTabs::rippleStyle() const
{
    Q_D(const QtMaterialTabs);
