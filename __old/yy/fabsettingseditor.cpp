...
FloatingActionButtonSettingsEditor::FloatingActionButtonSettingsEditor(QWidget *parent)
    : QWidget(parent),
      ...
      m_fab(new QtMaterialFloatingActionButton(QIcon("../qt-material-widgets/ic_star_black_24px.svg")))
{
...
void FloatingActionButtonSettingsEditor::updateWidget()
{
    ...
    {
    case 0:
        m_fab->setRole(XXMaterial::Default);
        break;
    case 1:
        m_fab->setRole(XXMaterial::Primary);
        break;
    case 2:
        m_fab->setRole(XXMaterial::Secondary);
        break;
    default:
        break;
    }
    ...
    {
    case 0:
        m_fab->setRippleStyle(XXMaterial::CenteredRipple);
        break;
    case 1:
        m_fab->setRippleStyle(XXMaterial::PositionedRipple);
        break;
    case 2:
        m_fab->setRippleStyle(XXMaterial::NoRipple);
        break;
    default:
        break;
    }
